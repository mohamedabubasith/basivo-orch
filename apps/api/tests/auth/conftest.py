...
os.environ.setdefault("JWT_SECRET", "test-jwt-secret-" + "b" * 40)
os.environ.setdefault("REFRESH_TOKEN_SECRET", "test-refresh-secret-" + "c" * 40)
os.environ.setdefault("CSRF_SECRET", "test-csrf-secret-" + "d" * 40)
