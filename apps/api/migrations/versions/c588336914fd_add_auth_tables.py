...
def upgrade() -> None:
    ...
    op.create_index('ix_audit_event_action_created', 'audit_event', ['action', 'created_at'], unique=False)
    op.create_index(op.f('ix_audit_event_created_at'), 'audit_event', ['created_at'], unique=False)
    op.create_index('ix_audit_event_user_created', 'audit_event', ['user_id', 'created_at'], unique=False)
    ...
    op.create_index('ix_membership_org_role', 'membership', ['organization_id', 'role'], unique=False)
    op.create_index('ix_membership_org_user', 'membership', ['organization_id', 'user_id'], unique=False)
    ...
    op.create_index(op.f('ix_recovery_code_code_hash'), 'recovery_code', ['code_hash'], unique=False)
