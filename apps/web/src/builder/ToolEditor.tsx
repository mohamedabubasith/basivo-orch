      ...
      <AnimatePresence initial={false}>
        {tools.map((tool, index) => (
          <motion.div
            ...
            className="overflow-hidden rounded-lg border border-ink-700/70 bg-ink-950/40"
          >
            <button
              type="button"
            ...
            {open === index && (
              <div className="space-y-3 border-t border-ink-700/60 p-3">
                ...
                <button
                  ...
                  className="text-[0.68rem] underline decoration-dotted underline-offset-2"
        ...
        {parameters.map((parameter, index) => (
          <div key={index} className="flex items-center gap-1.5">
            ...
            <button
              ...
              className="flex-none rounded p-1 text-ink-500 hover:text-ink-200"
            >
